...
export const currencyToCountry = {
    // Валюты и соответствующие им страны
    ...
    IQD: 'iq', IRR: 'ir', ISK: 'is', JMD: 'jm', JOD: 'jo', JPY: 'jp', KES: 'ke', KGS: 'kg',
    ...
    SCR: 'sc', SDG: 'sd', SEK: 'se', SGD: 'sg', SHP: 'sh', SLL: 'sl', SOS: 'so', SPL: 'pl',
    SRD: 'sr', STN: 'st', SYP: 'sy', SZL: 'sz', THB: 'th', TJS: 'tj', TMT: 'tm', TND: 'tn',
    TOP: 'to', TRY: 'tr', TTD: 'tt', TVD: 'tv', TWD: 'tw', TZS: 'tz', UAH: 'ua', UGX: 'ug',
    USD: 'us', UYU: 'uy', UZS: 'uz', VES: 've', VND: 'vn', VUV: 'vu', WST: 'ws', XAF: 'cm',
    XCD: 'ag', XOF: 'bj', XPF: 'nc', YER: 'ye', ZAR: 'za', ZMW: 'zm', ZWL: 'zw'
    // Добавьте остальные валюты по необходимости
};